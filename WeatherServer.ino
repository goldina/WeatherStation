...
#include <Adafruit_BME280.h>                            // air pressure & temperature sensor
...
#define DATAPIN         (D4)                           // radio data pin, must use pin that can interrupt on any level change
...
const char* ssid = "gemini";                                           // local WiFI
const char* password = "DinaMay19982003abcdP";
...
Adafruit_BME280 bme;                                   // I2C Pressure Sensor

ESP8266WebServer server ( 80 );                       // Web stuff

TFT_eSPI tft = TFT_eSPI();                            // TFT Monitor 
